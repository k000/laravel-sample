        ...
        <footer>
             <div class="container">
               <div class="col-xs-6 col-sm-6 headerNavBtn">
                    <P class="text-center">  <a class="navbar-brand" href="{{ url('/kiyaku') }}">利用規約</a></p>
                    Copyright © 2018 GeekGray. All Rights Reserved.
              </div>
              ...
              <div class="col-xs-6 col-sm-6 headerNavBtn">
                    ...
                    @foreach($select_cat as $index => $name)
                      <li><a href="{{ action('PostController@category',['id' => $name]) }}">{{ $name }}</a></li>
                    @endforeach
